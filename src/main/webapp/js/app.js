...
var discussShow = byServices.factory('DiscussShow', function($resource) {
	return $resource('api/v1/discuss/show/:discussId',{}, {
...
byApp.config(['$routeProvider',
  function($routeProvider) {
    $routeProvider
    .when('/users/home', {templateUrl: 'views/users/home.html', controller: 'DiscussListController'})
...
//	.when('/discuss/new/A', {templateUrl: 'views/discuss/create.html', controller: 'DiscussCreateController'})
    ...
    .when('/discuss/:discussId', {templateUrl: 'views/discuss/detail.html', controller: 'DiscussDetailController'});
