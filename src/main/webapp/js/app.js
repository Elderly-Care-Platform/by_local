...
var discussByUserFilter = byServices.factory('UserDiscussList', function ($resource) {
    ...
    ///start here
    return $resource('api/v1/discuss/list/:discussType/:topicId/:subTopicId/:userId', {}, {
        get: {
            method: 'GET',
            params: {discussType: '@discussType', topicId: '@topicId', subTopicId: '@subTopicId', userId: '@userId'}
        }
...
byApp.config(['$routeProvider',
    function ($routeProvider) {
        $routeProvider
            ...
            .when('/dependent/list/:userId', {
                templateUrl: 'views/users/dependents.html',
                controller: 'DependentListController'
            })
            .when('/dependent/:userId/:id', {
                templateUrl: 'views/users/create3.html',
                controller: 'DependentShowEditController'
            })
            ...
            .when('/discuss/:discussType/list/all', {
                templateUrl: 'views/discuss/discussion.html',
                controller: 'DiscussListController'
            })
            .when('/discuss/:topicId/all', {
                templateUrl: 'views/discuss/discussion.html',
                controller: 'DiscussOneTopicAllSubTopicListController'
            })
            .when('/discuss/:discussType/:topicId/:subTopicId', {
                templateUrl: 'views/discuss/discussion.html',
...
//	.when('/discuss/new/A', {templateUrl: 'views/discuss/create.html', controller: 'DiscussCreateController'})
            .when('/discuss/showedit/:discussId', {
                templateUrl: 'views/discuss/edit.html',
                controller: 'DiscussCreateController'
            })
            .when('/discuss/edit/:discussId', {
                templateUrl: 'views/discuss/list.html',
                controller: 'DiscussCreateController'
            })
            .when('/discuss/delete/:discussId', {
                templateUrl: 'views/discuss/list.html',
                controller: 'DiscussDeleteController'
            })
            .when('/search/:term/:disType', {
                templateUrl: 'views/discuss/search.html',
                controller: 'DiscussSearchController'
            })
            ...
            .when('/discuss/:discussId', {
                ...
                controller: 'DiscussPreviewController'
            });
...
//detail.html
byControllers.controller('DiscussPreviewController', ['$scope', '$rootScope', '$routeParams', '$location', 'DiscussShow', 'UserDiscussList',
    function ($scope, $rootScope, $routeParams, $location, DiscussShow, UserDiscussList) {
        ...
        $scope.discuss2 = UserDiscussList.get({
            discussType: discussType,
            topicId: topicId,
            subTopicId: subTopicId,
            userId: $scope.discuss.userId
        });
    }]);
...
byControllers.controller('UserDiscussListController', ['$scope', '$rootScope', '$routeParams', 'UserDiscussList',
    function ($scope, $rootScope, $routeParams, UserDiscussList) {
        ...
        $scope.discuss2 = UserDiscussList.query({
            discussType: discussType,
            topicId: topicId,
            subTopicId: subTopicId,
            userId: userId
...
byControllers.controller('DiscussOneTopicOneSubTopicListController', ['$scope', '$route', '$rootScope', '$location', '$routeParams', 'DiscussOneTopicOneSubTopicList', 'DiscussOneTopicOneSubTopicListCount',
    function ($scope, $route, $rootScope, $location, $routeParams, DiscussOneTopicOneSubTopicList, DiscussOneTopicOneSubTopicListCount) {
        ...
        //queries to get the numbers
        $scope.discuss_questions = DiscussOneTopicOneSubTopicList.query({
            discussType: "Q",
            topicId: topicId,
            subTopicId: subTopicId
        });

        $scope.discuss_posts = DiscussOneTopicOneSubTopicList.query({
            discussType: "P",
            topicId: topicId,
            subTopicId: subTopicId
        });

        $scope.discuss_articles = DiscussOneTopicOneSubTopicList.query({
            discussType: "A",
            topicId: topicId,
            subTopicId: subTopicId
        });
            ...
            $(function () {
                ...
                if ($(".discussion-page").length) {
                    ...
                    $(".ask-question").click(function (e) {
                        ...
                        $("body").scrollTop(st);
                        $(".ask-question-textarea").animate(obj, 500, function () {
                            $("body").scrollTop(st);
                        }).addClass("exp");
...
byControllers.controller('DiscussDetailController', ['$scope', '$rootScope', '$routeParams', '$route', '$location', 'DiscussShow', 'DiscussComment',
    function ($scope, $rootScope, $routeParams, $route, $location, DiscussShow, DiscussComment) {
...
var commentController = function ($scope, $rootScope, $routeParams, DiscussShow, DiscussComment, discussService) {
    ...
    $scope.saveDiscussComment = function (discussId, discussType) {
        alert("type = " + discussType + " :: id = " + discussId);
        ...
        alert("text = " + $scope.newDiscussComment.discussCommenContent);
