byApp.config(['$routeProvider',
    function($routeProvider) {
        $routeProvider
            ...
            .when('/users/login', {templateUrl: 'app/components/login/registration.html?versionTimeStamp=%PROJECT_VERSION%', controller: 'RegistrationController'})
            ...
            .when('/users/resetPassword/:resetPasswordCode', {templateUrl: 'app/components/login/resetPassword.html?versionTimeStamp=%PROJECT_VERSION%', controller: 'LoginController'});
