...
BY.config.home = {
    '0' : {
        'name':'Services',
        'desc':'Need a doctor on call? Or a nursing alistingPageUrle? Or even a yoga instructor at home? Check out our services directory with reviews and overviews, to find a solution. ',
