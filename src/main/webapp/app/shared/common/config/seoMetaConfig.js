...
BY.config.seo = {
    'home' : {
        title: "BeautifulYears - Everything about senior care in India",
        imageUrl: "",
        description: "Ask and share anything about senior care or aging.Find any service for seniors or senior living facilities.Buy products that improve lives of seniors",
        keywords: ['Beutifulyears', 'senior citizen', 'elderly care', 'senior care', 'ageing', 'aging', 'elder care', 'elder care products', 'senior care services', 'old age home',
            'senior living', 'care for elderly', 'elder care services', 'elder care community', 'elder care in India', 'senior care in India']
    },
